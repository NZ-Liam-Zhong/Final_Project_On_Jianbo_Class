...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1.00\linewidth]{feature_debuggin_left.png}
\end{figure}
\begin{table}[h]
\centering
...
\hline
\end{tabular}
\caption{An example of feature debugging with LLaVA \cite{ncutpytorch}}
\end{table}
...
\begin{itemize}
    ...
    \item Repetition of action executions - allowing for fine-grained pertubation selections,
...
Interestingly, we observe rapid cluster/color reassignments at points of transition between different stages of robot interactions. Senstivity to these is further indicative of semantic understanding of commonplace steps in a task such as Pick and Place.
